...
public class Task04Main {
    ...
    public static void main(String[] args) {
        ...
        Stream<String> stream = input.lines().flatMap(line -> pattern.splitAsStream(line.toLowerCase()));
        ...
        map.entrySet().stream().filter(s -> !s.getKey().equals(""))
                .sorted(Map.Entry.<String, Long>comparingByValue().reversed().thenComparing(Function.identity(), Map.Entry.comparingByKey()))
